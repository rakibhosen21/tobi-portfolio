...
const links = [
  ...
  { href: "#collaborations", label: "Teams" },
  { href: "/posts", label: "Creation" },
  { href: "#services", label: "Services" },
  { href: "#faq", label: "Questions" },
  { href: "#recent", label: "Analytics" },
...
export function SiteHeader() {
  ...
  return (
    <>
      <header className="sticky top-0 z-30 border-b border-border/80 bg-bg/75 backdrop-blur-md">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-3 px-4 sm:h-16 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              className="relative z-50 grid size-11 place-items-center rounded-lg text-fg xl:hidden"
      ...
      {open && (
        <div className="fixed inset-x-0 top-14 bottom-0 z-40 overflow-y-auto bg-bg px-4 py-5 sm:top-16 xl:hidden">
          <nav className="mx-auto grid max-w-6xl gap-1">
            ...
            <div className="mt-3 flex flex-col gap-2">
              ...
              <a
                href="/hire"
                onClick={() => setOpen(false)}
                className="inline-flex h-11 items-center justify-center rounded-full bg-fg text-sm font-medium text-bg"
              >
                Hire me
              </a>
            </div>
