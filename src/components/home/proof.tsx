...
export function Proof() {
  return (
    <section id="proof" className="px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {SITE.proof.map((post) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="glass-card group flex flex-col rounded-xl p-4 transition-transform duration-200 hover:-translate-y-0.5"
            >
